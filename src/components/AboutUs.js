	...
	return (
		<>
			<div class='about-main-container'>
				<div class="col-sm-10 about-col-10">
					<header>
					...
					<div className='col-md-12 col-sm-12 row'>
						<div className='col-md-6 col-sm-6' style={{ paddingLeft: "6%" }}>
					...
					<p style={{ paddingLeft: "5%", paddingTop: "4%", color: "grey" }}>Get a better insight of my skills and past work experience. <a target={'_blanl'} href={Resume} download><b>Download CV</b></a>.</p>
				</div>
			</div>
		</>
	)
